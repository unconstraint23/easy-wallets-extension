...
import { Wallet, Plus, Download, Settings, Key, Shield, ArrowLeft } from 'lucide-react';
...
const WalletPage: React.FC<WalletPageProps> = ({ onNavigate }) => {
  ...
  const handleImportWallet = () => {
    if (importPrivateKey && importWalletName.trim()) {
      importWallet(importPrivateKey, importWalletName.trim());
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 p-6">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-xl font-bold">设置钱包密码</h1>
          </div>
